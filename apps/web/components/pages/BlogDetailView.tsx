    ...
    <>
      ...
      <section className="section-padding bg-background relative overflow-hidden">
        <article className="container-luxury max-w-4xl">
          <Reveal>
            <div className="group relative rounded-3xl border border-gold-200/60 bg-card p-8 sm:p-12 shadow-sm transition-all duration-500 hover:border-gold-300 hover:shadow-xl hover:shadow-gold-500/5">
              
              {/* شريط معلومات المقال (التاريخ والكاتب) */}
              <div className="mb-8 flex flex-wrap items-center gap-4 border-b border-gold-100 pb-6 text-xs sm:text-sm text-muted">
                {post.date && (
                  <div className="inline-flex items-center gap-2 rounded-full border border-gold-200/80 bg-gold-400/10 px-3.5 py-1.5 font-medium text-foreground">
                ...
                {post.category && (
                  <div className="inline-flex items-center gap-2 rounded-full border border-gold-200 bg-gold-400/10 px-3.5 py-1.5 font-semibold text-gold-600">
              ...
              {/* نص المقال الرئيسي */}
              <div className="whitespace-pre-line text-base sm:text-lg leading-relaxed text-foreground font-normal">
