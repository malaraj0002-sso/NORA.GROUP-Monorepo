      ...
      <section className="section-padding bg-background relative overflow-hidden">
        <div className="container-luxury grid grid-cols-1 items-start gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-7">
            <Reveal>
              <div className="group relative rounded-2xl border border-gold-200/60 bg-card p-8 shadow-sm transition-all duration-500 hover:border-gold-300 hover:shadow-xl hover:shadow-gold-500/5">
                
                {/* الشارة العلوية */}
                <div className="inline-flex items-center gap-2 rounded-full border border-gold-200 bg-gold-400/10 px-3.5 py-1 text-xs font-semibold text-gold-600 mb-8">
                ...
                <div className="space-y-6">
                  <ContactRow icon={Phone} label={nav.callUs}>
                    <a
                      href={tel}
                      className="text-lg font-bold text-foreground transition-colors duration-300 hover:text-gold-600"
                      dir="ltr"
                    >
                  ...
                  <ContactRow icon={Mail} label="Email">
                    <a
                      ...
                      className="break-all text-lg font-bold text-foreground transition-colors duration-300 hover:text-gold-600"
                    >
                      {settings.email}
                    </a>
                  </ContactRow>
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <Reveal delay={120}>
              <div className="group relative flex flex-col items-center rounded-2xl border border-gold-200/60 bg-card p-8 shadow-sm transition-all duration-500 hover:border-gold-400 hover:shadow-xl hover:shadow-gold-500/10 text-center">
                
                <div className="relative mb-6 rounded-xl border border-gold-100 bg-white p-4 shadow-inner">
                  <Image
                    src={settings.qrUrl}
...
function ContactRow({
  ...
  return (
    <div className="flex items-start gap-4">
      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-gold-200/80 bg-gold-400/10 text-gold-600 shadow-sm transition-all duration-300 group-hover:bg-gold-400/20">
        <Icon className="h-5 w-5" />
      </div>
      <div>
        <p className="mb-0.5 text-xs font-semibold tracking-wider text-muted uppercase">{label}</p>
        {children}
      </div>
    </div>
  );
